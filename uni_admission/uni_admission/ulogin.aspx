<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ulogin.aspx.cs" Inherits="uni_admission.ulogin" %>
...
<body class="header">
   <form id="form1" runat="server">
    ...
    <p style="text-align:center; color:black; font-size:40px;">&nbsp;</p>
        <p style="text-align:center; color:darkblue; font-size:40px;"><u><b>Log In Here</b></u></p>
        <p style="text-align:center; color:black; font-size:40px;">
            <asp:Table ID="uulogin" runat="server" HorizontalAlign="center" >
                ...
                <asp:TableRow>
                    <asp:TableCell>
                        <asp:TextBox ID="input2" runat="server" placeholder="Password" BackColor="#CCFFFF"  Font-Bold="True" ForeColor="Black" Width="250px"  BorderColor="purple" BorderWidth="5px" Height="40px" TextMode="Password">
                        </asp:TextBox>
                    </asp:TableCell>
                    <asp:TableCell>
        ...
        <p style="text-align:center; color:black; font-size:15px;">
            <asp:CheckBox ID="CheckBox2" runat="server" Text="Remember Me" ForeColor="darkred" Font-Bold="true" />
        </p>
        <p style="text-align:center; color:black; font-size:40px;">
            
            <asp:Button ID="login2" runat="server" Text="Log In" Font-Bold="true" BackColor="darkblue" Font-Size="Medium" BorderStyle="Dashed" ForeColor="White" BorderColor="black" Height="40px" Width="80px" OnClick="login2_Click"/>
